...
( function () {
	...
	function initHeaderScroll() {
		...
		function staticUntil() {
			/*
			 * Особое поведение шапки нужно только на первом экране
			 * главной и только шире 700: там он занимает окно целиком и
			 * шапка не должна на него наезжать. Ниже 700 первый экран
			 * идёт обычным блоком, и шапка работает как на любой другой
			 * странице, без отдельной логики.
			 *
