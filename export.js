...
(async () => {
  ...
  for (const page of pages) {
     ...
     * («?topic=…», «page/2/»). Заменяем вместе с закрывающей кавычкой,
     * иначе адрес с двумя темами (?topic=animation,branding) совпал бы
     * с одиночным по началу строки и превратился в битую ссылку.
     */
    ...
    /*
     * Несколько тем сразу отдельным файлом не снять — таких сочетаний
     * слишком много. Без скрипта такие ссылки ведут на общий блог, а со
     * скриптом до перехода не доходит: фильтр отбирает карточки на
